...
let factsService = new BaseCrudApiService(baseUrl, "/data/facts", sessionService);
...
let dashboardComponent = new DashboardComponent(factsService, renderBody, dashboardTemplate);
let createComponent = new CreateComponent(factsService, renderBody, createTemplate, router);
let detailsComponent = new DetailsComponent(authService, factsService, renderBody, detailsTemplate, router);
let editComponent = new EditComponent(factsService, renderBody, editTemplate, router);
